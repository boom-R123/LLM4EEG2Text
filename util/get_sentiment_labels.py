...
sentiment_labels_task1_csv_path = './data/ZuCo/task_materials/sentiment_labels_task1.csv'
sentiment_labels = {}
...
output_dir = f'./data/ZuCo/task1-SR/sentiment_labels'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

with open(os.path.join(output_dir, 'sentiment_labels.json'), 'w') as out:
    json.dump(sentiment_labels,out,indent = 4)
    print('write to ./data/ZuCo/task1-SR/sentiment_labels/sentiment_labels.json')
